...
export default class GpproPlugin {
    ...
    /**
     * @param {GpproContainer} core
     */
    setContainer(core) {
        if (!(core instanceof GpproContainer)) {
            throw new Error('Plugin was given an invalid GpproContainer');
        }
        this._core = core;
    }
