...
import GpproColor from './GpproColor';
import GpproContextMenu from "./GpproContextMenu";
import { DateTime } from 'luxon';

export default class GpproCalendar {
    ...
    constructor(gppro, element, options) {
        ...
        let calendarOptions = {
            ...
            eventWillUnmount: (unmountInfo) => {
                ...
                if (!this.isGpproSource(unmountInfo.event)) {
                    return;
                }
            ...
            eventMouseLeave: (mouseLeaveInfo) => {
                if (!this.isGpproSource(mouseLeaveInfo.event)) {
                    return;
                }
            ...
            eventDidMount: (arg) => {
                arg.el.addEventListener('contextmenu', (jsEvent) => {
                    ...
                    if (!event.allDay) {
                        ...
                        API.get(url, {}, result => {
                            const contextMenu = new GpproContextMenu('calendar_contextMenu');
    ...
    convertSourceForCalendar(apiItem) {
        ...
        return {
            ...
            tags: apiItem.tags,
            color: color,
            textColor: GpproColor.calculateContrastColor(color),
        };
    }
