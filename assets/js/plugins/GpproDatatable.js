...
import GpproContextMenu from "../widgets/GpproContextMenu";

export default class GpproDatatable extends GpproPlugin {
    ...
    {
        GpproContextMenu.createForDataTable(selector);
    }
