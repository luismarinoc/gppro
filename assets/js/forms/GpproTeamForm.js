...
import GpproColor from "../widgets/GpproColor";

export default class GpproTeamForm extends GpproFormPlugin {
    ...
    _createMember(option)
    {
        ...
        newWidget = newWidget.replace(/#000000/g, GpproColor.calculateContrastColor(option.dataset.color));
