            ...
            ->children()
                ...
                ->arrayNode('branding')
                    ...
                    ->children()
                        ...
                        ->end()
                        ->scalarNode('vat_id')
                            ->defaultValue('77.073.462-2')
                        ->end()
                        ->scalarNode('address')
                            ->defaultValue('Avenida Apoquindo 4700, Depto. 11, Las Condes, Santiago')
                        ->end()
                        ->scalarNode('phone')
                            ->defaultValue('+56 9 44516977')
                        ->end()
                        ->scalarNode('email')
                            ->defaultValue('info@gpartnerc.com')
                        ->end()
                        ->scalarNode('website')
                            ->defaultValue('www.gpartnerc.com')
                        ->end()
                    ->end()
                ->end()
