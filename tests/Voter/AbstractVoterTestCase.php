...
abstract class AbstractVoterTestCase extends TestCase
{
    ...
    protected function getRolePermissionManager(array $permissions = [], bool $overwrite = false): RolePermissionManager
    {
        if (!$overwrite) {
            ...
            $roleTeamlead = ['view_team_member', 'view_rate_own_timesheet', 'view_rate_other_timesheet', 'hourly-rate_own_profile', 'view_team', 'edit_team'];
            ...
            $permissions = [
                ...
                'ROLE_SUPER_ADMIN' => array_merge($activities, $projects, $customers, $invoice, $invoiceTemplate, $invoiceAll, $timesheet, $timesheetOthers, $profile, $profileOther, $user, $rate, $rateOther, $roleSuperAdmin, $teams),
            ];
        }
